...
class ResearchesControllerTest < ActionController::TestCase
  ...
  test "should create research" do
    assert_difference('Research.count') do
      post :create, research: { data: @research.data, question: @research.question, range: @research.range, subquestion: @research.subquestion, type: @research.type }
    end
  ...
  test "should update research" do
    patch :update, id: @research, research: { data: @research.data, question: @research.question, range: @research.range, subquestion: @research.subquestion, type: @research.type }
    assert_redirected_to research_path(assigns(:research))
  end
